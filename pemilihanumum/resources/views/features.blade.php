...
<main>
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <h2 class="pb-2 border-bottom">Fitur Website Pemilihan Umum</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fs-3 text-body-emphasis">Sistem Manajemen Pemilu</h3>
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fs-3 text-body-emphasis">Registrasi Calon Legislatif Pusat DPR, DPD, DPRD I, DPRD II</h3>
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fs-3 text-body-emphasis">Pengisian Portofolio Caleg (Bagi yang Lolos Registrasi)</h3>
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fs-3 text-body-emphasis">Kampanye Online dan Pelaporan oleh Partai dan Caleg</h3>
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fs-3 text-body-emphasis">Pengaduan Kecurangan dan Hoax oleh Masyarakat</h3>
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fs-3 text-body-emphasis">Sistem Rekapitulasi Penghitungan Suara</h3>
