      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow">
          ...
          <div class="modal-body p-5 pt-0">
            <form method="POST" action="{{ route('loginpemilihan') }}">
              @csrf
              ...
              <button class="w-100 mb-3 btn btn-lg rounded-3 btn-danger" type="submit">Login</button>
            </form>
            <p>Belum punya akun? <a href="/pemilihan/register">Daftar disini</a>.</p>
          </div>
        </div>
      </div>
    </div>
